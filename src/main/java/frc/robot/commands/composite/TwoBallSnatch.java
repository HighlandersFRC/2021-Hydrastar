    ...
    public TwoBallSnatch(
        ...
        addCommands(
                new ParallelRaceGroup(
                        new DriveBackwards1(drive, peripherals, 116, 0.35, false, 19), new SmartIntake(magIntake, lights, ballCount)),
                new ParallelRaceGroup(new NavxTurnOneSide(peripherals, drive, 45), new SmartIntake(magIntake, lights, ballCount)),
                new ParallelRaceGroup(
                        new DriveBackwards1(drive, peripherals, 7, 0.35, false, 45), new SmartIntake(magIntake, lights, ballCount)),
